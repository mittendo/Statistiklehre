...
qplot(Year, alldeaths,  data=himicanes, color=Gender_MF, size=I(3))+ scale_colour_manual(values=c("blue", "red"))
# inputPanel(
...
<div class="notes">
Hier Link auf PNAS einfügen und demonstrieren
Ebenfalls: Link auf die Rohdaten
</div> 
