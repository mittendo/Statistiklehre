...
questions[1]<-"Die Brenndauer einer Glühbirne ist eine Zufallsvariable."
solutions[1]<-TRUE
questions[2]<- "Beträgt die Brenndauer einer Glühbirne 1342 Stunden, so sagt man,
dass 1342 die Realisation einer Zufallsvariablen ist."
solutions[2]<-TRUE
questions[3] <- "Bevor eine Glühbirne durchgebrannt ist, hat die Zufallsvariable Brenndauer meiner Glühbirne unendlich viele mögliche Werte."
solutions[3]<-TRUE
