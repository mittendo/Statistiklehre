...
questions<-c(
  ...
  'Haben Sie in den letzten 12 Monaten plattdeutsche Bücher gekauft oder geschenkt bekommen? – Antwort: gekauft, geschenkt bekommen, weder gekauft noch geschenkt bekommen', 
...
\begin{question}
Das Institut für Niederdeutsche Sprache ließ im Jahr 2007 eine Umfrage über die Verbreitung der plattdeutschen Sprache durchführen. Geben Sie bei den folgenden dort u.a. gestellten Fragen an, um welche Merkmalsart es sich bei der Antwort handelt.
