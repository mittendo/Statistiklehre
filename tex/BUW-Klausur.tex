...
%% headings
\markboth{\textnormal{\bf \large Quantitative Methoden Politikwissenschaft: \myID}}%
{\textnormal{\bf \large Quantitative Methoden Politikwissenschaft: \myID}}
...
\thispagestyle{empty}
{\sf
\textbf{\LARGE{Bergische Universit{\"a}t Wuppertal}}

\textbf{\Large{FB G - Fachgebiet Politikwissenschaft}}

\textbf{\large{MAP: POL KB 1.2 - Einführung in die empirisch-politikwissenschaftlichen Methoden}}



\textbf{\large{Klausur \myDate \hfill Klausur ID \myID}}

\vspace*{2cm}

\begin{tabular}{p{14cm}}
\textbf{Name:} \hrule \\[1.5cm]
\textbf{Matrikelnummer:} \hrule \\[1.5cm]
